...
class PeakProximity(strax.OverlapWindowPlugin):
    ...
    def setup(self):
        ...
        self.min_area_fraction = self.config['min_area_fraction']
        self.nearby_window = self.config['nearby_window']
        self.peak_max_proximity_time = self.config['peak_max_proximity_time']
