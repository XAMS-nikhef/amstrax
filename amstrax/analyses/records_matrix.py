# From https://github.com/XENONnT/amstrax/blob/master/amstrax/analyses/records_matrix.py
...
@amstrax.mini_analysis(requires=('records',),
                       warn_beyond_sec=10,
...
def records_matrix(records, time_range, seconds_range, config, to_pe,
    ...
    try:
        ...
        wvm = wvm.astype(np.float32) * 1 / dt
