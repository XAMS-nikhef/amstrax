...
def main(args):
    ...
    print('Processing raw_records in amstraxer_easy')
    daqst.make(run_id, 'raw_records', progress_bar=True)
    print('Processing records in amstraxer_easy')
    daqst.make(run_id, 'records', progress_bar=False)
