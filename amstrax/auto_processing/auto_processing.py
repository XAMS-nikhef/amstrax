    ...
    while 1:
        ...
        for run_doc in run_docs_to_do[:max_jobs]:
            ...
            if process_stomboot:
                ...
                subprocess.run(f"python3 /home/xams/carlo/software/amstrax/amstrax/auto_processing/process_run.py {run_name} --target records --output_folder {output_folder}", shell=True)
            time.sleep(2)
